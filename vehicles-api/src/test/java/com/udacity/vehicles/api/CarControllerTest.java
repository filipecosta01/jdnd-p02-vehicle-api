...
public class CarControllerTest {
    ...
    public void listCars() throws Exception {
        mvc.perform(
                get(new URI("/cars"))).andExpect(status().is(HttpStatus.OK.value()))
    ...
    public void deleteCar() throws Exception {
        ...
        // Car does not exist anymore, override setup to avoid returning data
        given(carService.findById(any())).willThrow(CarNotFoundException.class);

        mvc.perform(
                get(new URI("/cars/1"))).andExpect(status().is(HttpStatus.NOT_FOUND.value()))
                .andReturn();
    }
